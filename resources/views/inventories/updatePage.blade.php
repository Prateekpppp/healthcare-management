    ...
    <div class="col-md-12 main">
        ...
        <div class="row">
            <div class="col-lg-12 d-flex flex-row justify-content-between align-items-center">
                ...
                <a href="{{route('pages.inventories')}}" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span> View All
                </a>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <form class="row" action="{{route('post.updateInventory')}}" method="post">
                        @csrf
                        @if(isset($data))
                        ...
                        <div class=" col-md-4 form-group">
                            ...
                            <input type="text" name="quantity" class="form-control" id="quantity" required="" value="{{$data->quantity ?? ''}}">
                        </div>
